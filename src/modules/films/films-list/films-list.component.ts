...
export class FilmsListComponent implements OnInit, AfterViewInit {
  ...
  expandedElement: Film | null;
  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;

  constructor(private filmsServerService: FilmsServerService) {}

  createEvent(expandedElement,film){
    console.log("Expanded element:" + expandedElement);
    //console.log(film);
  ...
  ngOnInit(): void {
    ...
    this.expandedElement = new Film(undefined,undefined);
  }
